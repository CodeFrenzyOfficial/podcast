...
export default function CarouselCard({ episodeDetail: desc, imgSrc, title, videoSrc }: CarouselDataType) {
    return (
        <div className="flex min-h-[30vh] md:min-h-[50vh] rounded-2xl overflow-hidden">
            <div className="w-1/2 md:w-1/2 py-2 px-4 grid place-items-center bg-white">
                <div className="space-y-2 md:space-y-4">
                    ...
                    <p className="text-neutral-400 select-none">{desc}</p>
                    <EpisodeButton content="Check Episode" link={videoSrc} contentClassName="text-xs md:text-base" className="px-2 md:px-5" />
                </div>
            </div>
