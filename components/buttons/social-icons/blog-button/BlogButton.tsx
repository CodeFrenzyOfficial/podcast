...
export default function BlogButton({
    ...
    return (
        <div className={cn('w-fit py-2 px-8 flex justify-center items-center gap-2 rounded-full bg-yellow-500 text-white relative overflow-hidden group/card-btn transition-all duration-300', className)}>
